                                ...
                                <div class=" mt-4 mt-lg-0" >
                                    ...
                                    <form class="mb-0 row"  action="#" method="post" >
                                        ...
                                        <div class="col-md-12 nobottommargin" style='    text-align: center;margin-top: 20px;'>
                                            ...
                                            <button class="button btn btn-lg btn btn-danger button-circle button-large text-white ml-0 mt-3 colordarkgreen" type="button" name="submit_now" value="submit">Buy Now</button>
                                        </div>
                                        <div class="clear"></div>
