						...
						<form>
							<div class="row">
								<div class="form-group col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="contact-fname" id="input_fname" required="" placeholder="Your NAme *" class="form-control">
									...
									<input type="email" name="contact-subject" id="input_subject" required="" placeholder="Subject" class="form-control">
								</div>
								<div class="form-group col-md-6 col-sm-6 col-xs-12">
									<textarea name="contact-message" id="textarea_message" placeholder="Your message" rows="4" class="form-control"></textarea>
									<button id="btn_submit" type="submit" title="Send Your Message">Send Your Message</button>
								</div>
							</div>
